...
# Reads current CPU and RAM usage every call. Returns which model tier to use based on thresholds.
# This implements the dynamic model switching that is a core contribution of the REAF-5G framework.

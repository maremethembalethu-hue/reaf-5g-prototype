...
HEAVY_MODEL_PATH  = os.path.join(MODEL_DIR, "heavy_xgboost_5.onnx")
LITE_MODEL_PATH   = os.path.join(MODEL_DIR, "label_decision_tree_5.onnx")
HEAVY_SCALER_PATH = os.path.join(MODEL_DIR, "heavy_scaler_5.pkl")
LITE_SCALER_PATH  = os.path.join(MODEL_DIR, "lite_scaler_5.pkl")
LABEL_ENCODER_PATH = os.path.join(MODEL_DIR, "label_encoder_5.pkl")
